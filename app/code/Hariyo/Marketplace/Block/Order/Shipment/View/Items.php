 ...
 */
namespace Hariyo\Marketplace\Block\Order\Shipment\View;
...
//        $type = $this->_getItemType($item);
        ...
        if($type == 'bundle'){
            ...
            $block= $this->getLayout()->createBlock('Hariyo\Marketplace\Block\Order\Item\Renderer\DefaultRenderer')->setItem($item)->setTemplate('order/shipment/view/items/default.phtml');
        }
