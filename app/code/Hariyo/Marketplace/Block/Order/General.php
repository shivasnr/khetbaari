...
//        $type = $this->_getItemType($item);
        ...
        if($type == 'bundle'){
            ...
            $block= $this->getLayout()->createBlock('Hariyo\Marketplace\Block\Order\Item\Renderer\DefaultRenderer')->setItem($item)->setTemplate('order/view/items/default.phtml');
        }
...
//        $block = $this->getItemRenderer($type)->setItem($item);
    ...
    public function getGeneralInfo() {
        ...
        try {
            ...
            $this->mp_logHelper->info($e->getMessage());
        }
