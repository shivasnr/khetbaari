...
class Section extends \Hariyo\Marketplace\Block\Product\Base {
    ...
    protected function _prepareLayout() {
        if ($this->getProduct() && $this->getProduct()->getTypeId() == \Magento\ConfigurableProduct\Model\Product\Type\Configurable::TYPE_CODE) {
            $this->setChild('quick_create', $this->getLayout()->createBlock('\Hariyo\Marketplace\Block\Product\Section\Quickcreate', 'marketplace.product.section.quickcreate')
            );
        }
    }
