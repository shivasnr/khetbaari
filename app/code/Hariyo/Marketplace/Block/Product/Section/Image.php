...
class Image extends \Hariyo\Marketplace\Block\Product\Base {
    ...
    public function __construct(
        ...
        foreach ($this->getImageTypes() as $key => $val) {
            if ($product && $product->getData($key) && $product->getData($key) != '') {
                ...
                $this->_image_values[$key] = $this->_objectManager->get("Hariyo\Marketplace\Helper\Uploader")->getNoImageText();
            }
        }
    }
