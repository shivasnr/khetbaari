...
class MassUpdate extends \Hariyo\Marketplace\Block\Product\Base {
    ...
    public function getMassDeleteUrl() {
        return $this->_objectManager->get("\Hariyo\Marketplace\Helper\Data")->getFrontUrl('product', 'delete', ['action' => 'mass']);
    }

    public function getMassStatusUrl() {
        return $this->_objectManager->get("\Hariyo\Marketplace\Helper\Data")->getFrontUrl('product', 'statusUpdate', ['action' => 'mass']);
    }
