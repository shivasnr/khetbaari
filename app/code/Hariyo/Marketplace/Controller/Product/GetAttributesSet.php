...
class GetAttributesSet extends ParentController {
    ...
    public function execute() {
        ...
        try {
            ...
            $block = $this->_viewLayoutFactory->create()->createBlock('\Hariyo\Marketplace\Block\Product\Attributeselection');
            ...
            $this->mp_logHelper->createFileAndWriteLogData(
                    \Hariyo\Marketplace\Helper\Log::INFOTYPEERROR, 'Controller Product/GetAttributesSet::execute()', $ex->getMessage()
            );
        }
