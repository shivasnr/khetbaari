...
class Edit extends ParentController {
    ...
    public function __construct(
            ...
            \Hariyo\Marketplace\Helper\Log $logHelper
    ) {
    ...
    public function execute() {
        ...
        $this->validateParamId("\Hariyo\Marketplace\Model\Product", ['product_id' => $this->getRequest()->getParam('id')]);
...
//                }
                ...
                $this->mp_logHelper->createFileAndWriteLogData(
                    \Hariyo\Marketplace\Helper\Log::INFOTYPEERROR, 'Controller Product\Edit::save()', $message
                );
...
//                    $this->_objectManager->get("\Hariyo\Marketplace\Helper\Email")->sendProductApprovalRequestEmail($this->_customerInfo['entity_id'], $product_id);
                ...
                try {
                    ...
                    $this->mp_logHelper->createFileAndWriteLogData(
                            \Hariyo\Marketplace\Helper\Log::INFOTYPEERROR, 'Controller Product\Edit::saveProductMappingAction()', $message
                    );
                }
            }
        } catch (\Exception $e) {
