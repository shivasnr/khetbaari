...
(function($) {
    ...
    function MultipleSelect($el, options) {
        ...
        this.$drop = $('<div class="ms-drop ' + options.position + '" style="display:none;"></div>');
    ...
    MultipleSelect.prototype = {
        ...
        getSelects: function(type) {
            var that = this,
                texts = [],
                values = [];
            var replace_val = new RegExp(this.options.charReplace, 'g');
            this.$drop.find('input[' + this.selectItemName + ']:checked').each(function() {
                var label = $(this).parent().text();
                texts.push(label.replace(replace_val, ''));
