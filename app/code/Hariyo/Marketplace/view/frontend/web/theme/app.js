...
jQuery(function () {
  ...
  jQuery("#vss_marketplace_page").removeClass("hold-transition");
...
//    jQuery('#vss_marketplace_page').tooltip({
...
function _init() {
  ...
  jQuery.AdminLTE.layout = {
    ...
    fix: function () {
      ...
      if (jQuery("#vss_marketplace_page").hasClass("fixed")) {
  ...
  jQuery.AdminLTE.pushMenu = {
    activate: function (toggleBtn) {
      ...
      jQuery(document).on('click', toggleBtn, function (e) {
        ...
        if (jQuery(window).width() > (screenSizes.sm - 1)) {
          if (jQuery("#vss_marketplace_page").hasClass('sidebar-collapse')) {
            jQuery("#vss_marketplace_page").removeClass('sidebar-collapse').trigger('expanded.pushMenu');
          } else {
            jQuery("#vss_marketplace_page").addClass('sidebar-collapse').trigger('collapsed.pushMenu');
          }
        }
        //Handle sidebar push menu for small screens
        else {
          if (jQuery("#vss_marketplace_page").hasClass('sidebar-open')) {
            jQuery("#vss_marketplace_page").find('.content-wrapper').trigger('click');
            //jQuery("#vss_marketplace_page").removeClass('sidebar-open').removeClass('sidebar-collapse').trigger('collapsed.pushMenu');
          } else {
            jQuery("#vss_marketplace_page").addClass('sidebar-open').trigger('expanded.pushMenu');
          }
        }
      });
      ...
      jQuery(".content-wrapper").click(function () {
        ...
        if (jQuery(window).width() <= (screenSizes.sm - 1) && jQuery("#vss_marketplace_page").hasClass("sidebar-open")) {
          jQuery("#vss_marketplace_page").removeClass('sidebar-open');
        }
      });

      //Enable expand on hover for sidebar mini
      if (jQuery.AdminLTE.options.sidebarExpandOnHover
        || (jQuery('#vss_marketplace_page').hasClass('fixed')
        && jQuery('#vss_marketplace_page').hasClass('sidebar-mini'))) {
        this.expandOnHover();
      }
    },
    expandOnHover: function () {
      ...
      jQuery('.main-sidebar').hover(function () {
        if (jQuery('#vss_marketplace_page').hasClass('sidebar-mini')
          && jQuery("#vss_marketplace_page").hasClass('sidebar-collapse')
          && jQuery(window).width() > screenWidth) {
          _this.expand();
        }
      }, function () {
        if (jQuery('#vss_marketplace_page').hasClass('sidebar-mini')
          && jQuery('#vss_marketplace_page').hasClass('sidebar-expanded-on-hover')
          && jQuery(window).width() > screenWidth) {
          _this.collapse();
        }
      });
    ...
    expand: function () {
      jQuery("#vss_marketplace_page").removeClass('sidebar-collapse').addClass('sidebar-expanded-on-hover');
    },
    collapse: function () {
      if (jQuery('#vss_marketplace_page').hasClass('sidebar-expanded-on-hover')) {
        jQuery('#vss_marketplace_page').removeClass('sidebar-expanded-on-hover').addClass('sidebar-collapse');
      }
    }
  };
  ...
  jQuery.AdminLTE.tree = function (menu) {
    ...
    jQuery(document).off('click', menu + ' li a')
      .on('click', menu + ' li a', function (e) {
        ...
        if ((checkElement.is('.treeview-menu')) && (checkElement.is(':visible')) && (!jQuery('#vss_marketplace_page').hasClass('sidebar-collapse'))) {
          //Close the menu
  ...
  jQuery.AdminLTE.controlSidebar = {
    ...
    activate: function () {
      ...
      btn.on('click', function (e) {
        ...
        if (!sidebar.hasClass('control-sidebar-open')
          && !jQuery('#vss_marketplace_page').hasClass('control-sidebar-open')) {
          //Open the sidebar
    ...
    open: function (sidebar, slide) {
      ...
      if (slide) {
        ...
        jQuery('#vss_marketplace_page').addClass('control-sidebar-open');
      }
    },
    ...
    close: function (sidebar, slide) {
      if (slide) {
        ...
        jQuery('#vss_marketplace_page').removeClass('control-sidebar-open');
      }
    },
    _fix: function (sidebar) {
      var _this = this;
      if (jQuery("#vss_marketplace_page").hasClass('layout-boxed')) {
...
//        jQuery("i", element).children(":first")
