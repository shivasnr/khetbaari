...
class OrderList extends ParentController {
    ...
    public function execute() {
        ...
        if($this->mp_request->getParam('isAjax') && $this->mp_request->getParam('isAjax') == true){
            $data = $this->_layout->getBlockSingleton(\Knowband\Marketplace\Block\Order\OrderList::class)->getSellerOrderList();
            $json = [
        ...
        $resultPage->getConfig()->getTitle()->prepend(__("Seller's Account-Orders"));
        return $resultPage;
    }
}
