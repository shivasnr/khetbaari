...
//                }
                ...
                $this->mp_logHelper->createFileAndWriteLogData(
                        \Knowband\Marketplace\Helper\Log::INFOTYPEERROR, 'Controller Product\NewAction::save()', $message
                );
...
//                    $this->_objectManager->get("\Knowband\Marketplace\Helper\Email")->sendProductApprovalRequestEmail($this->_customerInfo['entity_id'], $product_id);
                ...
                try {
                    ...
                    $this->mp_logHelper->createFileAndWriteLogData(
                            \Knowband\Marketplace\Helper\Log::INFOTYPEERROR, 'Controller Product\NewAction::saveProductMappingAction()', $message
                    );
                }
            }
        } catch (\Exception $e) {
