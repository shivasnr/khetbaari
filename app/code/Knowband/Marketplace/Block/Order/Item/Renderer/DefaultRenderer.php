...
namespace Knowband\Marketplace\Block\Order\Item\Renderer;
 ...
 */
class DefaultRenderer extends \Knowband\Marketplace\Block\Order\General
{
    /**
     * Magento string lib
     *
    ...
    public function getItemPriceHtml($item = null)
    {
        ...
        $this->setItem($item);
        return $this->setTemplate('order/items/price/unit.phtml')->toHtml();
    }
    ...
    public function getItemRowTotalHtml($item = null)
    {
        ...
        $this->setItem($item);
        return $this->setTemplate('order/items/price/row.phtml')->toHtml();
    }
    ...
    public function getItemRowTotalAfterDiscountHtml($item = null)
    {
        ...
        $this->setItem($item);
        return $this->setTemplate('order/items/price/total_after_discount.phtml')->toHtml();
    }
}
