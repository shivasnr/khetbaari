 ...
 */
namespace Knowband\Marketplace\Block\Order\Items;
...
class AbstractItems extends \Magento\Framework\View\Element\Template
{
    ...
    public function __construct(
        ...
        $this->mp_dataHelper = $this->_objectManager->get("\Knowband\Marketplace\Helper\Data");
    ...
    public function getItemHtml(\Magento\Framework\DataObject $item)
    {
        ...
        if($type == 'bundle'){
            ...
            $blockObj= $this->getLayout()->createBlock('Knowband\Marketplace\Block\Order\Item\Renderer\DefaultRenderer')->setItem($item)->setTemplate('order/view/items/default.phtml');
        }
