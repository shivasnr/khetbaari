 ...
 */
namespace Knowband\Marketplace\Block\Order\Shipment\Create;
...
//        $type = $this->_getItemType($item);
        ...
        if($type == 'bundle'){
            ...
            $block= $this->getLayout()->createBlock('Knowband\Marketplace\Block\Order\Item\Renderer\DefaultRenderer')->setItem($item)->setTemplate('order/shipment/create/items/default.phtml');
        }
