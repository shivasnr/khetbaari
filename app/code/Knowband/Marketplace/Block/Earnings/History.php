...
class History extends \Magento\Framework\View\Element\Template {
    ...
    public function getList() {
        ...
        $report_format = (isset($post_data['format']) && array_key_exists($post_data['format'], $reportsHelper->getAllReportFormat()) ? $post_data['format'] : \Knowband\Marketplace\Helper\Reports::REPORT_FORMAT_DAILY);
    ...
    public function reportType(&$collection, $type) {
        ...
        switch ($type) {
            case \Knowband\Marketplace\Helper\Reports::REPORT_FORMAT_DAILY: {
            ...
            case \Knowband\Marketplace\Helper\Reports::REPORT_FORMAT_WEEKLY: {
            ...
            case \Knowband\Marketplace\Helper\Reports::REPORT_FORMAT_MONTHLY: {
            ...
            case \Knowband\Marketplace\Helper\Reports::REPORT_FORMAT_YEARLY: {
