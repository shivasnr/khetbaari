...
class Subproduct extends \Knowband\Marketplace\Block\Product\Base 
{    
    ...
    public function getSelectedGroupSubProducts(){
        return $this->_objectManager->get('\Knowband\Marketplace\Helper\Product')->getSelectedGroupSubProducts();
    }
