...
class ProcessOnNewOrder implements ObserverInterface {
    ...
    public function execute(\Magento\Framework\Event\Observer $observer) {
        try {
                        ...
                        if ($is_new) {
                            try {
                                ...
                                $this->mp_logHelper->createFileAndWriteLogData(
                                        \Knowband\Marketplace\Helper\Log::INFOTYPEERROR, 'Observer ProcessOnNewOrder::execute()', $message
                                );
                            }
                        }
            ...
            $this->mp_logHelper->createFileAndWriteLogData(
                    \Knowband\Marketplace\Helper\Log::INFOTYPEERROR, 'Observer ProcessOnNewOrder::execute()', $e->getMessage()
            );
        }
    }
