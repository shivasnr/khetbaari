    ...
    public function execute(\Magento\Framework\Event\Observer $observer) {
        try {
            if($this->_sessionManager->getRegisterAsSeller()){
                ...
                if ($seller_count <= \Knowband\Marketplace\Helper\Seller::SELLER_REGISTER_ALLOWED) {
            ...
            $this->mp_logHelper->createFileAndWriteLogData(
                    \Knowband\Marketplace\Helper\Log::INFOTYPEERROR, 'Observer SaveAsSeller::execute()', $e->getMessage()
            );
        }
    }
}
